# Auto-generated Julia wrapper for StdLibTest
# Generated: 2026-01-01 16:15:11
# Generator: RepliBuild Wrapper (Introspective: DWARF metadata)
# Library: libStdLibTest.so
...
const LIBRARY_PATH = "/home/grim/Desktop/Projects/RepliBuild.jl/test/stdlib_test/julia/libStdLibTest.so"
...
const METADATA = Dict(
    ...
    "function_count" => 26,
    "generated_at" => "2026-01-01T16:15:08.677"
)
...
"""
    time_diff_seconds(start::DateInfo, end::DateInfo) -> Cdouble
...
function time_diff_seconds(start::DateInfo, end::DateInfo)::Cdouble
    ccall((:time_diff_seconds, LIBRARY_PATH), Cdouble, (DateInfo, DateInfo,), start, end)
end
