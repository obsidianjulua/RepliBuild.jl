...
const METADATA = Dict(
    ...
    "function_count" => 57,
    "generated_at" => "2026-03-05T00:13:20.888"
)
...
unsafe_convert(::Type{Ptr{FFTResult}}, obj::ManagedFFTResult) = obj.handle
...
# Allow passing Managed object to ccall expecting Ptr
unsafe_convert(::Type{Ptr{ODEResult}}, obj::ManagedODEResult) = obj.handle
...
# Allow passing Managed object to ccall expecting Ptr
unsafe_convert(::Type{Ptr{SplineInterpolation}}, obj::ManagedSplineInterpolation) = obj.handle
...
# Allow passing Managed object to ccall expecting Ptr
unsafe_convert(::Type{Ptr{DenseMatrix}}, obj::ManagedDenseMatrix) = obj.handle
...
# Allow passing Managed object to ccall expecting Ptr
unsafe_convert(::Type{Ptr{Histogram}}, obj::ManagedHistogram) = obj.handle
...
# Allow passing Managed object to ccall expecting Ptr
unsafe_convert(::Type{Ptr{Polynomial}}, obj::ManagedPolynomial) = obj.handle
...
# Allow passing Managed object to ccall expecting Ptr
unsafe_convert(::Type{Ptr{SparseMatrix}}, obj::ManagedSparseMatrix) = obj.handle
...
function ode_result_destroy(result::Any)::Cvoid
...
function optimize_minimize(objective::Any, gradient::Any, x::Any, n::Csize_t, options::Any, final_state::Any, callback::Any, user_data::Any)::Status
...
function optimize_minimize_numerical_gradient(objective::Any, x::Any, n::Csize_t, options::Any, final_state::Any, callback::Any, user_data::Any)::Status
...
function solve_linear_system_lu(lu::Any, b::Any, x::Any, n::Csize_t)::Status
...
function solve_linear_system_qr(qr::Any, b::Any, x::Any)::Status
