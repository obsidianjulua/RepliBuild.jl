...
const PRESERVED_TOML_KEYS = [
    ...
    ("wrap", "shim_headers"),
    ("wrap", "cstring_owned"),
    # Which symbols do NOT belong in the wrapper is a judgement about the
    # library's API — generated byte-array globals, a vendored C++ error
    # hierarchy — and a source scan cannot re-derive it. Losing it on a forced
